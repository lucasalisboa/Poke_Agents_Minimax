...
class MiniMax_Lee_Togelius(Player): 
    ...
    def score(self, node, depth):
        ...
        myPoke = current_HP/max_current_HP
        opPoke = opponent_HP/max_opponent_HP
        score = myPoke - (3*opPoke) - (0.3*depth)
        node.score = score
        return score
...
async def main():
    ...
    minimax_player1 = MiniMax_Lee_Togelius(
        battle_format="gen8randombattle",
    )
